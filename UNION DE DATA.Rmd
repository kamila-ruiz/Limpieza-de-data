...
variable pobreza en dicotomica para continuar con estudio

```{r}
enaho$SI_POBREZA=apply(enaho[, c("POBREZA1", "POBREZA2")],
                       MARGIN = 1,
                       FUN = sum,
                       na.rm = TRUE)
enaho$SI_POBREZA
str(enaho$SI_POBREZA)
```
cambiar de nombre variable a NO_POBREZA
```{r}
names(enaho)[names(enaho)=="POBREZA3"] = "NO_POBREZA"
enaho$NO_POBREZA
```
